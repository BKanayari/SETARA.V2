    ...
    var body: some View {
        ...
        VStack {
            VStack {
                List {
                    if true {
                        if let participantss = SharedPreferences.shared.getParitcipant(name: participant.name) {
                        ...
                        Button {
                            if (nameItem.isEmpty || basePrice.isEmpty) {
                                ...
                                for i in 0..<(tmpParticipant.food.count ) {
                                    ...
                                    SharedPreferences.shared.addParcticipant(participantName: tmpParticipant)
